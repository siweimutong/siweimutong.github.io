...
<div class="project-item">
  <img class="project-img" src="{{ '/assets/img/ROS-RTEMS.png' | relative_url }}" alt="ROS-RTEMS">
...
<div class="project-item">
  <img class="project-img" src="{{ '/assets/img/Raspi5.png' | relative_url }}" alt="Xenomai for Raspberry Pi 5">
  <div class="project-body">
...
<div class="project-item">
  <img class="project-img" src="{{ '/assets/img/VLA.png' | relative_url }}" alt="Heterogeneous Autonomous Driving">
  <div class="project-body">
    ...
    <p class="project-desc"><span class="lang-en">Studies timing analysis and scheduling of computation and communication for real-time performance in heterogeneous autonomous driving systems.</span><span class="lang-zh">研究异构自动驾驶系统中计算与通信的时序分析与调度，保障系统的实时性能。</span></p>
  </div>
</div>

<div class="project-item">
  <img class="project-img" src="{{ '/assets/img/VNF.png' | relative_url }}" alt="Satellite-VNF-Placement">
  <div class="project-body">
